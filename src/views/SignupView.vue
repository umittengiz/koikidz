    ...
    <div class="
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        <div class="bg-white shadow rounded lg:w-1/3 md:w-1/2 w-full p-10 mt-16">
          ...
          <!-- Social account login START -->
          <div v-show="0">
            <button aria-label="Continue with google" role="button" class="
              focus:outline-none
              focus:ring-2
              focus:ring-offset-1
              focus:ring-gray-700
            ...
            <button aria-label="Continue with github" role="button" class="
              focus:outline-none
              focus:ring-2
              focus:ring-offset-1
              focus:ring-gray-700
            ...
            <button aria-label="Continue with twitter" role="button" class="
              focus:outline-none
              focus:ring-2
              focus:ring-offset-1
              focus:ring-gray-700
          ...
          <div class="mt-8">
            <router-link to="/signup/mother">
              <button role="button" aria-label="create my account" class="
