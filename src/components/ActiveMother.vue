        ...
        <table class="w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                <tr>
                    ...
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">05346272728</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">Giyaseddin(Cocugun Bilgilerine erisim???)</td>
                    <td class="whitespace-nowrap px-4 py-2">
                    <div class="flex w-full justify-evenly">
                        
                          <button class="bg-teal-500 px-5 mr-2 py-2 rounded-xl text-white">Onayla</button>
                            <button class="bg-rose-500 px-5 py-2 rounded-xl text-white">Reddet</button>
                ...
                <tr>
                    ...
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">₺150</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">05346272728</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">Remzi(Cocugun Bilgilerine erisim???)</td>
                    <td class="whitespace-nowrap px-4 py-2">
                    <div class="flex w-full justify-evenly">
                ...
                <tr>
                    ...
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">₺150</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">05346272728</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">Rifat(Cocugun Bilgilerine erisim???)</td>
                    <td class="whitespace-nowrap px-4 py-2">
                    <div class="flex w-full justify-evenly">
